...
def test_average():
    data = [DateInfo(date='2022-01-01', avg_temperature=24, sum_condition=8), 
...
def test_day_calc_temp():
    ...
    result = [DateInfo(date='2022-01-25', avg_temperature=average_temp, 
        sum_condition=1)]
...
def test_calc():
    ...
    result = CityData(
        city_name = "London", 
        dates = [DateInfo(date='2022-01-25', avg_temperature=15.0, 
            sum_condition=2)], 
        average_temp = 15.0, 
        average_condition = 2
    )
